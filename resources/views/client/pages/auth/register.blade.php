...
@section('description', 'Tạo tài khoản mới để truy cập các tính năng và quản lý đơn hàng tại cửa hàng của chúng tôi.')
@section('keywords', 'đăng ký, xác thực người dùng, đăng ký cửa hàng')
