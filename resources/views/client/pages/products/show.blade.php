...
@section('title', $product->title . ' - Shop Đồ ăn thú cưng')
@section('description', Str::limit($product->description, 160))
@section('keywords', 'đồ ăn, ' . $product->title . ', ' . $product->category->name)
